...
<div class="control-group">
  ...
  <div class="controls">
    <input id="nome" name="nome" type="text" value="<?php echo $nome ;?>" class="input-xlarge">
  </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="sobrenome" name="sobrenome" type="text" value="<?php echo $sobrenome ;?>" class="input-xlarge">
  </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="orgao" name="orgao" type="text" value="<?php echo $orgao ;?>" class="input-xlarge">
  </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="cargo" name="cargo" type="text" value="<?php echo $cargo ;?>" class="input-xlarge">
  </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="email" name="email" type="text" value="<?php echo $email ;?>" class="input-xlarge">
  </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="telefones" name="telefones" type="text" value="<?php echo $telefones ;?>" class="input-xlarge">
  </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="cep" name="cep" type="text" value="<?php echo $cep ;?>" class="input-medium">
  </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="cidade" name="cidade" type="text" value="<?php echo $cidade ;?>" class="input-xlarge">
  </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="bairro" name="bairro" type="text" value="<?php echo $bairro ;?>" class="input-xlarge">
  </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="logradouro" name="logradouro" type="text" value="<?php echo $logradouro ;?>" class="input-xlarge">
  </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="complemento" name="complemento" type="text" value="<?php echo $complemento ;?>" class="input-xlarge">
  </div>
</div>
