...
<form  name="arquivo-edit" method="post" action="arquivo.php" class="form-horizontal" >
<fieldset>
<!-- Form Name -->
...
<div class="control-group">
  ...
  <div class="controls">
    <select id="tipo" name="tipo" class="input-large">
      <?php
      $q = "SELECT * FROM tipo_arquivo ORDER BY sigla ASC";
...
<form  name="arquivo-add" method="post" action="arquivo.php" class="form-horizontal" >
<fieldset>
