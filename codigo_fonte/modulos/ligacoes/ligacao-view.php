...
<div class="control-group">
  ...
  <div class="controls">
    <select id="de" name="de" class="input-xlarge" disabled>
...
<div class="control-group">
  ...
  <div class="controls">
    <select id="para" name="para" class="input-xlarge" disabled
      <option>-- Selecione --</option>
      <?php
      $sql = "SELECT * FROM pessoas ORDER BY nome ASC";
      foreach($conn->query($sql) as $pessoa){
...
<div class="control-group">
  ...
  <div class="controls">
    ...
    <label class="radio" for="callType-0">
      <input type="radio" name="tipo" id="callType-0" value="<?php echo $tpd; ?>" <?php echo $checked; ?>  disabled />
      Recebida
    </label>
    <?php
   }
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="data" name="data" type="text" value="<?php echo $data ?>" class="input-small" disabled>
  </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="hora" name="hora" type="text" value="<?php echo $hora ?>" class="input-small" disabled>
  </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
    <select id="registradaPor" name="registradaPor" class="combobox input-large" disabled>
      <option>-- Selecione --</option>
      <?php
      $sql = "SELECT * FROM pessoas ORDER BY nome ASC";
      foreach($conn->query($sql) as $pessoa){
...
<div class="control-group">
  ...
  <div class="controls">
    <select id="situacao" name="situacao" class="input-large" disabled>
      <option>-- Selecione --</option>
...
<div class="control-group">
  ...
  <div class="controls">                     
    <textarea id="observacoes" name="observacoes" rows="5" disabled><?php echo $observacoes ?></textarea>
  </div>
</div>
