...
?>
  ...
  <div class="after-options">
    ...
    <ul class="unstyled">
      <li><a href="proposicao.php?a=add">Cadastrar Pessoa</a></li>
      <li><a href="proposicao.php?a=list">Pesquisar Pesquisar Pessoas</a></li>
      <li><a href="proposicao.php?a=edit&id=<?php echo $id ?>">Editar Novamente</a></li>
    </ul>
  </div>
